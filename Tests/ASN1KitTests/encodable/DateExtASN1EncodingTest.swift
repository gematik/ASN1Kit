...
class DateExtASN1EncodingTest: XCTestCase {
    ...
    func resource(file: String) -> String {
        return bundle.testResourceFilePath(in: DateExtASN1EncodingTest.bundleName, for: file)
    }
    ...
    typealias TestCase = (String, String, Date, ASN1DecodedTag, Bool)
    static let tests: [TestCase] = [
        ("Test generalizedTime Z", "generalized_time_1991-05-06_23-45-40Z.der",
                Date(timeIntervalSince1970: 673573540), .universal(.generalizedTime), true),
        ("Test generalizedTime -0700", "generalized_time_1991-05-06_16-45-40-0700.der",
                Date(timeIntervalSince1970: 673573540), .universal(.generalizedTime), false),
        ("Test UTCTime Z", "utctime_91-05-06_23-45-40Z.der",
                Date(timeIntervalSince1970: 673573540), .universal(.utcTime), true),
        ("Test UTCTime -0700", "utctime_91-05-06_16-45-40-0700.der",
                Date(timeIntervalSince1970: 673573540), .universal(.utcTime), false),
        ("Test UTCTime Z 2019", "utctime_19-02-22_10-41-16Z.der",
                Date(timeIntervalSince1970: 1550832076), .universal(.utcTime), true),
        ("Test UTCTime Z 2020", "utctime_20-11-04_12-45-08Z.der",
                Date(timeIntervalSince1970: 1604493908), .universal(.utcTime), true),
        ("Test generalizedTime A", "A_generalized_time_1985-11-06_21-06-27.3.der",
                Date(timeIntervalSince1970: 500159187.3), .universal(.generalizedTime), false),
        ...
        ("Test generalizedTime C", "C_generalized_time_1985-11-07_02-06-27.3-0500.der",
                Date(timeIntervalSince1970: 500177187.3), .universal(.generalizedTime), false),
        ("Test generalizedTime D", "D_generalized_time_1985-11-06_21-06.456.der",
                Date(timeIntervalSince1970: 500159187.36), .universal(.generalizedTime), false),
        ("Test generalizedTime E", "E_generalized_time_1985-11-06_21.14159.der",
                Date(timeIntervalSince1970: 500159309.724), .universal(.generalizedTime), false)
    ]
    ...
    func encodingTest(fileName: String, date: Date, tag: ASN1DecodedTag, also encode: Bool = true) {
        ...
        if encode {
            expect {
                try date.asn1encode(tag: tag).serialize()
            } == data
        }
        expect {
